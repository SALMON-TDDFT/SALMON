...
if(nproc_id_global==nproc_size_global-1)then
  ibox=totnum_aewald/nproc_size_global
  aewald_num=totnum_aewald-ibox*(nproc_size_global-1)
  aewald_sta=ibox*(nproc_size_global-1)+1
  aewald_end=totnum_aewald
else
  aewald_num=totnum_aewald/nproc_size_global
  aewald_sta=aewald_num*(nproc_id_global-1)+1
  aewald_end=aewald_num*nproc_id_global
end if
