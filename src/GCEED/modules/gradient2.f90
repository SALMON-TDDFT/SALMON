...
INTERFACE calc_gradient2
  ...
  MODULE PROCEDURE R_calc_gradient2,C_calc_gradient2
...
!=======================================================================
SUBROUTINE R_calc_gradient2(wk2,grad_wk)
!$ use omp_lib
...
END SUBROUTINE R_calc_gradient2

!=======================================================================
SUBROUTINE C_calc_gradient2(wk2,grad_wk)
!$ use omp_lib
...
END SUBROUTINE C_calc_gradient2

END MODULE gradient2_sub
