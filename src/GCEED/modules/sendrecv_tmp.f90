...
module sendrecv_tmp_sub
  ...
  interface sendrecv_tmp
    ...
    module procedure R_sendrecv_tmp, C_sendrecv_tmp
...
end subroutine C_sendrecv_tmp

!==================================================================================================

end module sendrecv_tmp_sub
