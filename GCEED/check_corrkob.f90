...
if(ilsda==0.or.nproc_ob==1)then
  if(iparaway_ob==1)then
    ...
    if(newrank_comm_grid==iquotient)then
      icorr_p=1
    else
      icorr_p=0
    end if
  else if(iparaway_ob==2)then
    if(newrank_comm_grid==mod(iob-1,nproc_ob))then
      icorr_p=1
    else
      icorr_p=0
    end if
  ...
  if(iparaway_ob==1)then
    if(newrank_comm_spin<nproc_ob_spin(1))then
      ...
      if(iob<=MST(1).and.newrank_comm_grid==iquotient)then
        icorr_p=1
      else
        icorr_p=0
      end if
      ...
      if(iob>=MST(1)+1.and.newrank_comm_grid==iquotient)then
        icorr_p=1
      else
        icorr_p=0
      end if
    ...
    if(newrank_comm_spin<nproc_ob_spin(1))then
      if(iob<=MST(1).and.newrank_comm_grid==mod(iob-1,nproc_ob_spin(1)))then
        icorr_p=1
      else
        icorr_p=0
      end if
    else
      if(iob>=MST(1)+1.and.newrank_comm_grid==mod(iob-1-MST(1),nproc_ob_spin(2)))then
        icorr_p=1
      else
        icorr_p=0
      end if
